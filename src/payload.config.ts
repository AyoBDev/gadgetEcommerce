...
export default buildConfig({
  ...
  typescript: {
    ...
    // payload-types.ts is hand-maintained (the generate:types CLI is broken in
    // this environment, and the full autogenerated types are incompatible with
    // how this codebase calls the local API). Disable boot-time regeneration so
    // dev/test runs don't clobber the hand-authored file.
    autoGenerate: false,
  },
  plugins: [
    s3Storage({
