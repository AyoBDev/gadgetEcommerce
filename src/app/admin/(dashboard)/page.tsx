...
export default async function AdminDashboardPage() {
  ...
  const cards: DashboardCard[] = [
    { label: 'Published', value: String(stats.publishedCount), href: '/admin/laptops?status=published' },
    { label: 'Out of stock', value: String(stats.outOfStockCount), href: '/admin/laptops?status=published&stock=out' },
    { label: 'Low stock (1–2)', value: String(stats.lowStockCount), href: '/admin/laptops?status=published&stock=low' },
    { label: 'Sales this month', value: String(stats.salesThisMonth), href: '/admin/orders' },
    { label: 'Revenue this month', value: formatNaira(stats.revenueThisMonthKobo), href: '/admin/orders' },
    { label: 'Pending deliveries', value: String(stats.pendingDeliveries), href: '/admin/orders?deliveryStatus=pending' },
  ];
    ...
    <Box>
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3, flexWrap: 'wrap', gap: 2 }}>
        ...
        <Stack direction="row" spacing={1}>
          ...
          <Button component={Link} href="/admin/orders/new" variant="outlined">
            Record a sale
          </Button>
        </Stack>
      </Box>
